...
namespace ConsoleApp7.Migrations
{
    ...
    [Migration("20200609180334_TPH_Entities")]
    partial class TPH_Entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleApp7.BlogTPH", b =>
                {
                    b.Property<int>("BlogId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ConsoleApp7.PostTPH", b =>
                {
                    b.Property<int>("PostId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("PostTPH");
                });

            modelBuilder.Entity("ConsoleApp7.WidgetTPH", b =>
                {
                    b.Property<int>("WidgetId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ConsoleApp7.VideoPostLL", b =>
                {
                    ...
                    b.HasData(
                        new { FostLLId = 2, Content = "Lareum ipsum, alpha, beta, crapper...", FlogLLId = 1, Title = "Hello World, The Movie", ReleaseDate = new DateTime(2019, 8, 14, 0, 0, 0, 0, DateTimeKind.Local), VideoTitle = "this is the Video Title" }
                    );
                });
            ...
            modelBuilder.Entity("ConsoleApp7.DumbAsAPostTPH", b =>
                {
                    b.HasBaseType("ConsoleApp7.PostTPH");

                    b.Property<bool>("Stupid");

                    b.ToTable("DumbAsAPostTPH");

                    b.HasDiscriminator().HasValue("DumbAsAPostTPH");
                });

            modelBuilder.Entity("ConsoleApp7.VideoPostTPH", b =>
                {
                    b.HasBaseType("ConsoleApp7.PostTPH");
                    ...
                    b.ToTable("VideoPostTPH");

                    b.HasDiscriminator().HasValue("VideoPostTPH");
                });
            ...
            modelBuilder.Entity("ConsoleApp7.PostTPH", b =>
                {
                    b.HasOne("ConsoleApp7.BlogTPH", "Blog")
                        .WithMany("Posts")
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ConsoleApp7.WidgetTPH", "Foobar")
                        .WithMany()
